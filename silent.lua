...
local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/Bart3kk/LinLib/refs/heads/main/MobileLibrary.lua'))()
Library:SetWatermark("pkplaysrblx - Mobile Supported")
